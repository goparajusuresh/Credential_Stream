...
public class Deploy_SmokeTest extends TestInit {
	public String Org_Name, ID_Number, Screen_Extenders, Screen_Extenders2, Survey_Name, Expected, Update_Pswd;
	Boolean actual;
	static LoggerUtil loggerUtil = new LoggerUtil(Deploy_SmokeTest.class);
	...
	public void VS_GM_01() {
		try {
			...
			Login.DeployLogin(SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Deploy_G_Username"),
					SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Deploy_G_Password"));
			// Verifying Global mode
			Login.CheckMode("Global", "global");
	...
	public void VS_FM_01() {
		try {
			...
			Login.DeployLogin(SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Deploy_F_Username"),
					SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Deploy_F_Password"));
	...
	public void VS_GM_03() {
		try {
			...
			// SeleniumTools.clickOnObject("xpath",
			// "//span[contains(text(),'References')]");

			// SeleniumTools.scrollToElementAndClick("xpath", "//div[@class='tree-container
			// k-widget k-treeview']//li[26]//span[@class='k-in']");
	...
	public void VS_FM_03() {
		try {
			...
			// Select Provider name
			// SeleniumTools.clickOnObject("xpath", "//span[text()='Anna, Jackson,']");
			// Thread.sleep(80000);

			// SeleniumTools.ScrollTo("xpath", "//div[@class='tree-container k-widget
			// k-treeview']//li[30]//span[@class='k-in']");

			SeleniumTools.ScrollTo("xpath", "//span[contains(text(),'References')]");
			// SeleniumTools.scrollToElementByXpath("xpath",
			// "//span[contains(text(),'References')]");
	...
	public void VS_GM_04() {
		try {
			...
			SeleniumTools.ScrollTo("xpath",
					"//div[@class='tree-container k-widget k-treeview']//li[29]//span[@class='k-in']");
			CoreUtil.imSleepy(5000);
			...
			SeleniumTools.clickOnObject("xpath", "//span[@class='codetext']//b[text()='JBMFC']");
			CoreUtil.imSleepy(5000);
	...
	public void VS_FM_04() {
		try {
			...
			SeleniumTools.clickOnObject("xpath", "//span[@class='codetext']//b[text()='W-001']");
			CoreUtil.imSleepy(10000);
			...
			SeleniumTools.ClearAndSetText("xpath", "//textarea[@id='comment']", "For Testing Purpose Only");
	...
	public void VS_GM_05() {
		try {
			...
			SeleniumTools.ClearAndSetText("xpath", "//input[@id='lookup-text-search']", "GLOBAL Hospital");
			CoreUtil.imSleepy(5000);
	...
	public void VS_FM_05() {
		try {
			...
			SeleniumTools.ClearAndSetTextEnter("xpath", "//input[@type='text']", "Facility");
			CoreUtil.imSleepy(5000);
			// SeleniumTools.clickOnObject("xpath", "//span[text()='Smoke, Test,']");
			// CoreUtil.imSleepy(9000);
	...
	@Test(description = "Add, modify, delete Payer Contract from provider record in Global Mode")
	public void VS_GM_06() {
		try {
			...
			// Enter Value in search box
			SeleniumTools.ClearAndSetTextEnter("xpath",
					"//div[@class='col-sx-6 divNoScroll k-pane k-scrollable']//input[@placeholder='Search for a Contract to Populate List']",
					"Blue");
			CoreUtil.imSleepy(10000);
			// Click on check all
			SeleniumTools.clickOnObject("xpath",
	...
	@Test(description = "Add, modify, delete Payer Contract from provider record in Facility Mode")
	public void VS_FM_06() {
		try {
			...
			SeleniumTools.ClearAndSetTextEnter("xpath", "//input[@id='availableFilter']", "Loc");
			CoreUtil.imSleepy(8000);
			// Click on check all
			SeleniumTools.clickOnObject("xpath",
					"//body/form[@id='form1']/div[@id='content']/div[@id='buttons']/div[1]/div[1]/div[1]/input[1]");
	...
	public void VS_GM_07() {
		try {
			...
			SeleniumTools.ClearAndSetText("xpath",
					"//echo-input[@class='ng-isolate-scope']//div[@class='ng-scope']//input[@id='year_cert']", "2020");
			CoreUtil.imSleepy(10000);
			...
			SeleniumTools.clickOnObject("xpath",
					"//body/form[@id='SpecialtiesController']/div[1]/div[1]/section[1]/div[3]/div[1]/echo-input[1]/div[1]/span[1]/span[2]/span[1]/span[2]");
			CoreUtil.imSleepy(8000);
	...
	public static void VS_GM_09() {
		try {
			...
			// Login to the Stage Application
			Login.StageLogin(SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Deploy_G_Username"),
					SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Deploy_G_Password"));
			SeleniumTools.switchToFrame("id", "mainFrame");
	...
	public static void VS_FM_09() {
		try {
			...
			// Login to the Stage Application
			Login.StageLogin(SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Deploy_F_Username"),
					SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Deploy_F_Password"));
			SeleniumTools.switchToFrame("id", "mainFrame");
			SeleniumTools.clickOnObject("xpath", "//div[@id='main-navigation']//img[@id='NavigationLogo']");
			CoreUtil.imSleepy(2000);
	...
	public void VS_GM_13() {
		try {
			...
			Login.DeployLogin(SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Deploy_G_Username"),
					SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Deploy_G_Password"));
			// Verifying global mode
			Login.CheckMode("Global", "facility");
			// ****Clicking on Setup
	...
	public void VS_GM_14() {
		try {
			...
			// grid-col']/div[1]/div[2]/table/tbody/tr[1]/td[3]");
			// CoreUtil.imSleepy(3000);
			// clicking on submit
	...
	public void VS_GM_15() {
		try {
			...
			/*
			 * //Clicking on ...Default Type SeleniumTools.clickOnObject("xpath",
			 * "//input[@name='btnDeftype']"); CoreUtil.imSleepy(15000);
			 * SeleniumTools.switchToDefaultFrame();
			 * SeleniumTools.waitForFrameToBeAvailable("xpath",
			 * "//iframe[@id='MainModalFrame']");
			 * SeleniumTools.waitForFrameToBeAvailable("xpath",
			 * "//frameset[@name='rightside']");
			 * SeleniumTools.waitForFrameToBeAvailable("xpath", "//frame[@name='eCMETOP']");
			 * //clicking ... C SeleniumTools.clickOnObject("xpath",
			 * "//table[@id='tbl_browser_tbl']/tbody/tr[2]/td[1]/a");
			 * SeleniumTools.switchToDefaultFrame(); SeleniumTools.switchToFrame("xpath",
			 * "//iframe[@id='mainFrame']");
			 * SeleniumTools.waitForFrameToBeAvailable("xpath", "//iframe[@name='Set up']");
			 * SeleniumTools.waitForFrameToBeAvailable("xpath",
	...
	public void VS_FM_15() {
		try {
			...
			/*
			 * //Clicking on ...Default Type SeleniumTools.clickOnObject("xpath",
			 * "//input[@name='btnDeftype']"); SeleniumTools.switchToDefaultFrame();
			 * SeleniumTools.waitForFrameToBeAvailable("xpath",
			 * "//iframe[@id='MainModalFrame']"); //clicking ... C
			 * SeleniumTools.clickOnObject("xpath",
			 * "//table[@id='tbl_browser_tbl']/tbody/tr[2]/td[1]/a");
			 * SeleniumTools.switchToDefaultFrame(); SeleniumTools.switchToFrame("xpath",
			 * "//iframe[@id='mainFrame']");
	...
	public void VS_GM_20() {
		try {
			// Login to the Stage Application
			Login.DeployLogin(SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Forgot_User"),
					SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Forgot_PasswordDeploy"));
			// Verifying Global mode
			Login.CheckMode("Global", "global");
			SeleniumTools.hoverElement("xpath", "//span[text()='Set up']");
			SeleniumTools.hoverElement("xpath", "//span[text()='System']");
			...
			SeleniumTools.clickOnObject("xpath",
					"//a[contains(@href, 'https://client.verity.cloud/DEPLOY/appweb/asp/resetpassword.aspx?TOKEN')]");
			CoreUtil.imSleepy(5000);
			...
			SeleniumTools.writeConfigFile(Constants.properties_stage, "Forgot_PasswordDeploy", Update_Pswd)
					.setProperty("Forgot_PasswordDeploy", Update_Pswd);
