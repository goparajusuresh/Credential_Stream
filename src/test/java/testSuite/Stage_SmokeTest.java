...
public class Stage_SmokeTest extends TestInit {
	public String Org_Name, ID_Number, Screen_Extenders, Screen_Extenders2, Survey_Name, Expected, Update_Pswd;
	Boolean actual;
	static LoggerUtil loggerUtil = new LoggerUtil(Stage_SmokeTest.class);
	...
	@Test(description = "Add, modify, delete Organization in Global mode")
	public void VS_GM_01() {
		try {
			...
			// SeleniumTools.ClearAndSetTextEnter("xpath", "//input[@placeholder='Search by
			// text']", "test");
	...
	public void VS_FM_01() {
		try {
			// Login to the Stage Application
			Login.StageLogin(SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Stage_F_Username"),
					SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Stage_F_Password"));
	...
	public void VS_GM_02() {
		try {
			...
			// Clicking on region
			SeleniumTools.clickOnObject("xpath",
					"//div[@class='tree-container k-widget k-treeview']/ul/li/div/span[contains(text(),'Regions')]");
	...
	public void VS_GM_03() {
		try {
			...
			SeleniumTools.ClearAndSetText("xpath", "//input[@type='text']", "Automation");
			CoreUtil.imSleepy(7000);
			SeleniumTools.clickOnObject("xpath",
			...
			SeleniumTools.ScrollTo("xpath",
					"//div[@class='tree-container k-widget k-treeview']//span[contains(text(),'References')]");
			CoreUtil.imSleepy(10000);
			// **SeleniumTools.scrollToElementAndClick("xpath",
			// "//div[@class='tree-container k-widget
			// k-treeview']//li[43]//span[@class='k-in']");
			// **Thread.sleep(20000);

			// SeleniumTools.scrollToElementByXpath("xpath", "//div[@class='tree-container
			// k-widget k-treeview']//li[33]");
			...
			// Enter Title
			SeleniumTools.ClearAndSetText("xpath", "//input[@id='title']", "Test");
			CoreUtil.imSleepy(2000);
			...
			SeleniumTools.clickOnObject("xpath",
					"//body/form[@id='ReferencesController']/div[1]/div[1]/custom-form[1]/section[1]/div[5]/div[1]/div[1]/div[1]/div[1]/echo-lookup[1]/div[1]/span[1]/button[1]");
			CoreUtil.imSleepy(5000);

			SeleniumTools.switchToFrame("xpath", "//iframe[@id='frame-modal-clone-1']");
			CoreUtil.imSleepy(5000);

			SeleniumTools.ClearAndSetText("xpath", "//input[@id='lookup-text-search']", "Verity QA Team1");
			CoreUtil.imSleepy(5000);
			...
			// Select Organization
			SeleniumTools.ClearAndSetText("xpath", "//input[@id='organizate']", "Testing only");
			CoreUtil.imSleepy(5000);

			// Enter AddressLine1
			SeleniumTools.scrollToElementAndClick("xpath", "//input[@id='addr']");
			CoreUtil.imSleepy(5000);
			SeleniumTools.ClearAndSetText("xpath", "//input[@id='addr']", "Lane123#01");
			CoreUtil.imSleepy(5000);

			// Enter Zip
			// SeleniumTools.ClearAndSetText("xpath", "//input[@id='zip']", "75050");
			// CoreUtil.imSleepy(5000);

			// Add Notes
			// SeleniumTools.scrollToElementAndClick("xpath", "//button[text()='Add
			// note']");
			// CoreUtil.imSleepy(5000);
			// SeleniumTools.ClearAndSetText("xpath", "//button[text()='Add note']",
			// "Testing Only");
			// CoreUtil.imSleepy(5000);
	...
	public void VS_GM_04() {
		try {
			...
			SeleniumTools.ScrollTo("xpath",
					"//div[@class='tree-container k-widget k-treeview']//li[37]//span[@class='k-in']");
			CoreUtil.imSleepy(5000);
			...
			SeleniumTools.clickOnObject("xpath", "//echo-lookup[@model='headerFormFields.chk_name']/div/span/button");
			// SeleniumTools.clickOnObject("xpath",
			...
			// SeleniumTools.clickOnObject("xpath", "//span[contains(text(),'carla')]");

			// SeleniumTools.clickOnObject("xpath", "//div[@class='ng-scope
			// k-mid']//span[text()='carla']");
			SeleniumTools.clickOnObject("xpath",
					"//body/form[@id='ChecklistBrowController']/div[1]/div[1]/div[1]/div[1]/ul[1]/li[4]/div[1]/span[1]");
			CoreUtil.imSleepy(5000);

			SeleniumTools.clickOnObject("xpath", "//span[@class='codetext']//b[text()='MWT1']");
			CoreUtil.imSleepy(5000);
			...
			SeleniumTools.clickOnObject("xpath",
					"//body/form[@id='WorkflowProviderAreaFormController']/div[1]/div[1]/section[1]/div[2]/div[1]/echo-lookup[1]/div[1]/span[1]/button[1]");
			CoreUtil.imSleepy(5000);
			...
			SeleniumTools.ClearAndSetTextEnter("xpath", "//textarea[@id='comment']", "Automation Testing only");
			CoreUtil.imSleepy(5000);
	...
	public void VS_FM_04() {
		try {
			...
			// Select Provider name
			// SeleniumTools.clickOnObject("xpath", "//span[text()='Facility,
			// Automation,']");
			// CoreUtil.imSleepy(5000);
			...
			SeleniumTools.clickOnObject("xpath", "//input[@id='dr_chk_facs']");
			CoreUtil.imSleepy(5000);
			...
			SeleniumTools.ClearAndSetTextEnter("xpath", "//textarea[@id='comment']", "Automation Testing Purpose");
			CoreUtil.imSleepy(5000);
	...
	public void VS_GM_05() {
		try {
			...
			SeleniumTools.clickOnObject("xpath",
					"//body/form[@id='ChecklistBrowController']/div[1]/div[1]/div[1]/div[1]/ul[1]/li[6]/div[1]/span[1]");
			// CoreUtil.imSleepy(3000);

			SeleniumTools.clickOnObject("xpath",
					"//body/form[@id='ChecklistBrowController']/div[1]/div[1]/div[1]/div[1]/ul[1]/li[6]/ul[1]/li[1]/div[1]/span[1]");
			// CoreUtil.imSleepy(3000);
			...
			// SeleniumTools.ClearAndSetTextEnter("xpath","//textarea[@class='form-control
			// ng-pristine ng-valid ng-touched' and @id='comment']","For Testing Only");
			// CoreUtil.imSleepy(3000);
	...
	public void VS_FM_05() {
		try {
			...
			SeleniumTools.clickOnObject("xpath",
					"//body/form[@id='ChecklistBrowController']/div[1]/div[1]/div[1]/div[1]/ul[1]/li[5]/div[1]/span[1]");
			// CoreUtil.imSleepy(5000);

			SeleniumTools.clickOnObject("xpath",
					"//body/form[@id='ChecklistBrowController']/div[1]/div[1]/div[1]/div[1]/ul[1]/li[5]/ul[1]/li[1]/div[1]/span[1]");
			// CoreUtil.imSleepy(5000);
			...
			// Select from search
			// SeleniumTools.clickOnObject("xpath", "//td[text()='Facility A']");
			// CoreUtil.imSleepy(10000);
	...
	public void VS_GM_06() {
		try {
			...
			SeleniumTools.ScrollTo("xpath",
					"//div[@class='tree-container k-widget k-treeview']/ul/li/div/span[contains(text(),'Verifications:')]");
			CoreUtil.imSleepy(5000);
			...
			// Enter Value in search box
			SeleniumTools.ClearAndSetTextEnter("xpath",
					"//div[@class='col-sx-6 divNoScroll k-pane k-scrollable']//input[@id='availableFilter']", "HHS");
			CoreUtil.imSleepy(9000);
			// Click on check all
			SeleniumTools.clickOnObject("xpath",
			...
			SeleniumTools.scrollToElementAndClick("xpath", "//input[@id='pin']");
			// CoreUtil.imSleepy(9000);

			SeleniumTools.ClearAndSetTextEnter("xpath", "//input[@id='pin']", "72188");
			// CoreUtil.imSleepy(5000);
	...
	public void VS_FM_06() {
		try {
			...
			SeleniumTools.ClearAndSetTextEnter("xpath",
					"//div[@class='col-sx-6 divNoScroll k-pane k-scrollable']//input[@id='availableFilter']", "1199");
			CoreUtil.imSleepy(9000);
			// Click on check all
			SeleniumTools.clickOnObject("xpath",
					"//body/form[@id='form1']/div[@id='content']/div[@id='buttons']/div[1]/div[1]/div[1]/input[1]");
	...
	public void VS_GM_07() {
		try {
			...
			SeleniumTools.switchToFrame("xpath", "//iframe[@id='frame-modal-clone-1']");
			SeleniumTools.ClearAndSetText("xpath", "//input[@id='lookup-text-search']", "Administrative Medicine");
			CoreUtil.imSleepy(10000);
	...
	public void VS_GM_14() {
		try {
			...
			// SeleniumTools.clickOnObject("xpath", "//div[@class='modal fade ng-scope
			// in']/div/div/div[2]/div[1]/div[2]/echo-lookup/div[1]/span/button");
			// CoreUtil.imSleepy(3000);
			// Selecting Region
			// SeleniumTools.switchToFrameByNumber(3);
			// SeleniumTools.ClearAndSetText("xpath",
			// "//div[@class='grids-ready']/div[1]/div[2]/div/div[2]/div[1]/input", "Te");
			// SeleniumTools.clickOnObject("xpath","//div[@class='grids-ready']/div[1]/div[2]/div/div[1]/div[2]/input");
			// CoreUtil.imSleepy(2000);
	...
	public void VS_FM_14() {
		try {
			...
			// clicking on Default User/Group ellipses
			SeleniumTools.clickOnObject("xpath",
					"//section[@class='section section-box ng-scope']/div[5]/div[1]/div/span[1]/button");//
			CoreUtil.imSleepy(4000);
			// selecting User
			SeleniumTools.switchToFrameByNumber(1);
			SeleniumTools.ClearAndSetText("xpath", "//div[@class='layout']/div/div[1]/div[1]/input", "A");
	...
	public void VS_GM_17() {
		try {
			...
			SeleniumTools.waitForFrameToBeAvailable("xpath", "//iframe[@id='frameContent']");
			SeleniumTools.clickOnObject("xpath",
					"//div[@class='col-md-4 col-xs-8 ng-scope']/label[text()='Region']/parent::div//button");
			SeleniumTools.switchToDefaultFrame();
	...
	@Test(description = "Ensure functioning 'Forgot pPassword' link on user login page")
	public void VS_GM_20() {
		try {
			...
			SeleniumTools.clickOnObject("xpath", "//span[@class='link action dropdown-link']/../div/ul/li[3]");
			...
			SeleniumTools.clickOnObject("xpath",
					"//a[contains(@href, 'https://client.verity.cloud/QA/appweb/asp/resetpassword.aspx?TOKEN')]");
			CoreUtil.imSleepy(5000);
	...
	@Test(description = " Dashboard – Expirables Alerts Widget – Add License Number")
	public void VS_GM_21() {
		try {
			// Login to the Stage Application
			Login.StageLogin(SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Stage_G_Username"),
					SeleniumTools.readConfigFile(Constants.properties_stage).getProperty("Stage_G_Password"));
			...
			SeleniumTools.waitForFrameToBeAvailable("xpath", "//iframe[@id='RightSideContents']");	
			SeleniumTools.waitForFrameToBeAvailable("xpath", "//iframe[@name='HomeContentFrame']");	
			// Clicking on Expirables Alert Widget
			SeleniumTools.clickOnObject("xpath", "//img[@id='Expirables']");
			SeleniumTools.waitForFrameToBeAvailable("xpath", "//iframe[@src='EchoAngular/Widgets/Expirables/Expirables.html']");	
			// Clicking on Records without Valid License
			SeleniumTools.clickOnObject("xpath", "//div[text()='Records without Valid License']");
			CoreUtil.imSleepy(10000);
			SeleniumTools.switchToDefaultFrame();
			SeleniumTools.waitForFrameToBeAvailable("xpath", "//iframe[@id='frame-modal-clone-1']");	
			//Entering license number
			SeleniumTools.clickOnObject("xpath", "//div[@id='expirables-kendo-div']/div[2]/table/tbody/tr[1]/td[6]");
			SeleniumTools.ClearAndSetTextEnter("xpath", "//div[@id='expirables-kendo-div']/div[2]/table/tbody/tr[1]/td[6]",SeleniumTools.getRandomNumbers());
			//click on OK
			SeleniumTools.clickOnObject("xpath", "//button[text()='OK']");
			CoreUtil.imSleepy(10000);
			/*
			 * //Close window SeleniumTools.scrollToElementByXpath("xpath",
			 * "//div[@id='expirables-kendo-div']/div[2]/table/tbody/tr[1]/td[11]");
			 * SeleniumTools.clickOnObject("xpath",
			 * "//div[@class='modal fade in']/div/div/div[1]/button");
			 * 
			 * //SeleniumTools.PressKey("ESCAPE"); SeleniumTools.switchToDefaultFrame();
			 * SeleniumTools.waitForFrameToBeAvailable("xpath", "//iframe[@name='Home']");
			 * SeleniumTools.waitForFrameToBeAvailable("xpath",
			 * "//iframe[@id='RightSideContents']");
			 * SeleniumTools.waitForFrameToBeAvailable("xpath",
			 * "//iframe[@name='HomeContentFrame']");
			 * 
			 * //Close Alert window SeleniumTools.clickOnObject("xpath",
			 * "//a[@class='remove']");
			 */
