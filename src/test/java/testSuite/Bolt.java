...
public class Bolt extends TestInit {
	...
	public void Bolt_SG_08() {
		try {
			...
			SeleniumTools.javascriptClick("//button[@id='btnResetMap']");
			SeleniumTools.getAlertText();
			SeleniumTools.closeTab();
			CoreUtil.imSleepy(2000);
	...
	public void Bolt_SG_19() {
		try {
			 ...
			 * driver.findElements(By.className("ng-binding ng-scope")); 
	...
	@Test(description = "Reports")
	public void Reports() {
		try {

			Login.HubLogin("navya.vempali@healthstream.com","Navya@1234");
